...
def home():
 ...
 html=html.replace('</body>',PERSIAN_DATE_SCRIPT+CLEAR_FORM_SCRIPT+UNIFIED_FILES_SCRIPT+MODQ_SCRIPT+PATIENT_LIST_SCRIPT+'</body>'); r=Response(html,mimetype='text/html'); r.headers['Cache-Control']='no-store, no-cache, must-revalidate, max-age=0'; return r
@app.route('/modq')
@login_required
